...
日期：2026-09-08。版本：**1.0.0 正式版**。[GitHub 发布页面](https://github.com/812344707/obsidian-review-center/releases/tag/1.0.0)。
...
- 正式发行提供程序独立附件、完整安装 ZIP、许可资料及 SHA-256 清单。

1.0.0 通过 GitHub 发布，沿用完成本地验收的程序；本轮不安装到用户正式知识库，也不提交 Obsidian 社区目录。目标手机平台、真机与真实同步保持待验证，未将窄屏模拟认作真机结果。详细证据、截图和安装包哈希见 [验证记录](1.0.0-validation.md)。
